...
@interface Config {
	...
	@AttributeDefinition(name = "Number of slaves", description = "The number of slaves in this battery rack (max. 22")
	int numberOfSlaves() default 20;

	@AttributeDefinition(name = "Alarm Level 2 Waiting Period ", description = "Time period in seconds that should be waited if an alarm 2 has been raised")
	int secondsToWaitAlarmLevel2() default 600;
