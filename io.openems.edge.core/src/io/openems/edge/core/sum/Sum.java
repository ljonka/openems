...
public class Sum extends AbstractOpenemsComponent implements OpenemsComponent, ModbusSlave {
	...
	public enum ChannelId implements io.openems.edge.common.channel.doc.ChannelId {
		...
		/**
		 * Holds the currently maximum possible power. This value is commonly defined by
		 * the inverter limitations (max apparent power).
		 * 
		 * <ul>
	...
	private final SumInteger<SymmetricEss> essMaxPower;	
	...
	private void addEss(SymmetricEss ess) {
		...
		this.essMaxPower.addComponent(ess);
	...
	protected void removeEss(SymmetricEss ess) {
		...
		this.essMaxPower.removeComponent(ess);
	...
	public Sum() {
		...
		this.essMaxPower = new SumInteger<SymmetricEss>(this, ChannelId.ESS_MAX_POWER,
	...
	public Channel<Integer> getEssMaxPower() {
		return this.channel(ChannelId.ESS_MAX_POWER);
	}
